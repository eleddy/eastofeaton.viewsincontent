...
def setup_product():
    ...
    import eastofeaton.viewsincontent
    zcml.load_config('configure.zcml', eastofeaton.viewsincontent)
    ...
    ztc.installPackage('eastofeaton.viewsincontent')
...
setup_product()
ptc.setupPloneSite(products=['eastofeaton.viewsincontent'])
